...
from cloudseg.utils.files import get_contained_dirs, get_contained_files
from cloudseg.datasets.optimization import optimize_dataset
from cloudseg.datasets.preprocessing import (
    process_irccam_img,
    process_vis_img,
    sun_correction,
...
from cloudseg.datasets.filtering import (
    filter_sun,
    filter_sparse,
    filter_manual,
)
from cloudseg.datasets.labeling import create_label_rb_threshold, create_label_adaptive
...
def create_dataset(
    ...
    use_manual_filter:
        ...
        created CSV file stored at `cloudseg/datasets/resources/filter_manual.csv`
    raw_data_path:
