...
def filter_manual(day, timestamps):
    ...
    data stored in the file `cloudseg/datasets/resources/filter_manual.csv`. This
    data was compiled by manually checking each day for bad weather conditions
    or equipment malfunction.
    """
    filename = os.path.join(PROJECT_PATH, "cloudseg/datasets/resources/filter_manual.csv")
    data = pd.read_csv(
        filename,
